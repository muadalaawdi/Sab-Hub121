...
-- // 1. AUTOLOADER & REJOIN ENGINE
local function SafeRejoin()
    -- This sends the loadstring command to the teleport queue
    local selfCode = 'loadstring(game:HttpGet("' .. GITHUB_LINK .. '"))()'
    
    if queue_on_teleport then 
        queue_on_teleport(selfCode) 
    end
...
frame.Size = UDim2.fromOffset(250, 160)
...
title.Size = UDim2.new(1, 0, 0, 40); title.Text = "ronaldothegond real sab hub"
title.TextColor3 = Color3.fromRGB(0, 220, 255); title.BackgroundTransparency = 1; title.Font = Enum.Font.GothamBold; title.TextSize = 11

-- // 3. MINIMIZE (RH LOGO)
local minBtn = Instance.new("TextButton", sg)
minBtn.Size = UDim2.fromOffset(60, 60); minBtn.Position = UDim2.new(0, 10, 0.5, 0)
minBtn.BackgroundColor3 = Color3.fromRGB(0, 200, 255); minBtn.Text = "RH"
minBtn.TextColor3 = Color3.fromRGB(15, 15, 20); minBtn.Font = Enum.Font.GothamBold; minBtn.TextSize = 25
minBtn.Visible = false; Instance.new("UICorner", minBtn).CornerRadius = UDim.new(0.5, 0)
Instance.new("UIStroke", minBtn).Thickness = 2

local function toggleUI()
    frame.Visible = not frame.Visible
    minBtn.Visible = not frame.Visible
end

local closeBtn = Instance.new("TextButton", frame)
closeBtn.Size = UDim2.fromOffset(30, 30); closeBtn.Position = UDim2.new(1, -35, 0, 5)
closeBtn.Text = "_"; closeBtn.BackgroundColor3 = Color3.fromRGB(200, 50, 50); closeBtn.TextColor3 = Color3.new(1,1,1)
